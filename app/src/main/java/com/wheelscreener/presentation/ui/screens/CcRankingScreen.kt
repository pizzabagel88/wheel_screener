...
import com.wheelscreener.presentation.viewmodel.CcRankingViewModel

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun CcRankingScreen(
    viewModel: CcRankingViewModel = hiltViewModel(),
    ...
    Scaffold(
        ...
        Column(
            ...
            Row(
                ...
                CcSortOption.values().forEach { option ->
                    FilterChip(
